...
params = [   (3.4, 1.2, -4.3, 0.9, 0.8, -2.1), # Langstrasse
             (3.4, 1.2, -4.3, 0.9, 0.8, -2.1), 
             (3.4, 1.2, -4.3, 0.9, 0.8, -2.1),
             (3.4, 1.2, -4.3, 0.9, 0.8, -2.1), # Sihl lokal
              
             (0.1, 3.4, -1.8, 0.4, 1.1, 0.), # Honggerberg
             (0.1, 3.4, -1.8, 0.4, 0.8, 0.), # ETH
             (0.1, 3.4, -1.8, 0.4, 0.8, 0.),
             (0.1, 3.4, -1.8, 0.4, 0.8, 0.),
